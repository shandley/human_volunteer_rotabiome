...
p.boxplot.phylum.1 <- ggboxplot(dat.1, x = "randomization_arm", y = "Abundance", outlier.shape = NA) +
  ...
  labs(title = "Figure S3", y = "Relative Abundance") +
  ylim(0,1.5) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
...
# Note: The UniFrac plot was not included in the final manuscript
...
ggarrange(p.ord.uni.shed, p.ord.wuni.shed, nrow = 2)
# Note: This figure was not included in the final manuscript but was discussed in the results
