...
```{r narrow-spectrum-boost-grid}
grid.arrange(volcano.d.9.narrow.boost, volcano.d0.narrow.boost, volcano.d7.narrow.boost, ncol = 3)
...
sample_data(ps1.d.9.broad)$randomization_arm
